...
(function (scenes) {
    var StartScene = /** @class */ (function (_super) {
        ...
        StartScene.prototype.Start = function () {
            ...
            this.welcomeLabel = new objects.Label("Maze Runner", "80px", "Consolas", "#FFFFFF", 320, 240, true);
            this.nameLabel = new objects.Label("by Raj Patel", "40px", "Consolas", "#FFFFFF", 320, 300, true);
